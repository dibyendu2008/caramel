...
<body>
   {{-- {{ dd($background_Change) }} --}}
    ...
    <nav class="navbar navbar-expand-lg navbar-light top-nav-bg">
        <div class="container">
            <a class="navbar-brand" href="https://caramel29.com/">
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link text-bolder active-nav"
                            href="https://caramel29.com/">{{ __('messages.home') }}<span
                    ...
                    @endif
					<li class="nav-item">
                        <a class="nav-link" href="https://kitchen.caramel29.com/">Kitchens</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="https://caramel29.com/our-story/">{{ __('messages.about_us') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link"
                            href="https://caramel29.com/contact-us/">{{ __('messages.contact_us') }}</a>
                    </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                @if ($toggle_restaurant_registration)
                                    <li>
                                        <a class="dropdown-item" href="{{ route('restaurant.create') }}">Request to list Kitchen
                                        </a>
                                    </li>
                                ...
                                @if ($toggle_dm_registration)
                                    <li><a class="dropdown-item"
                                            href="{{ route('deliveryman.create') }}">Join as Support Officer</a>
                                    </li>
                                @endif
                            </ul>
                        </li>
            ...
            @else
                col-md-3 @endif footer-col">
                    ...
                    <ul class="list-unstyled text-muted">
                        <li>
                            <a href="https://caramel29.com/our-story/">{{ __('messages.about_us') }}</a>
                        </li>
                        <li>
                            <a href="https://caramel29.com/contact-us/">{{ __('messages.contact_us') }}</a>
                        </li>
                        <li>
                            <a href="https://caramel29.com/privacy-policy/">{{ __('messages.privacy_policy') }}</a>
                        </li>

                        <li>
                            <a
                                href="https://caramel29.com/terms-and-conditions/">{{ __('messages.terms_and_condition') }}</a>
                        </li>
                    </ul>
                </div>
